			...
			<div class="col-md-6">
				<div class="callout callout-info">
					...
					<dl>
						...
						<dd><?php echo ucwords($brand_name) ?></dd>
						<dt>Amount:</dt>
						<dd>Php<?php echo ucwords($brand_price) ?></dd>
						<?php if($type == 2): ?>
...
<div class="modal-footer display p-0 m-0">
        <button type="button" class="btn btn-primary"  id="send_email">Submit</button>
...
<script>
	...
	$('#send_email').click(function(){
		uni_modal("Send Email to: <?php echo $brand_name ?>","manage_parcelsubmit.php?id=<?php echo $id ?>&cs=<?php echo $status ?>","")
	})
</script>