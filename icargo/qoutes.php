    ...
    <div class="page-heading header-text">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h1>Get A Quote</h1>
            <span>We are here to move it for you.</span>
          </div>
        </div>
      </div>
    </div>

    <div class="partners" style="margin-top:1px;background:#5088ee;height:250px">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <div class="owl-partners owl-carousel owl-carousel3" style="width:100%;" >
            
              <div class="partner-item">
              <img src="assets/images/affordabillity.png" alt="" style="width:80px;"></br>
              <h4 style="color:#fff;">AFFORDABILITY:</h4> Get the Best Prices from Various Cargo Companies.
              </div>
              
              <div class="partner-item">
              <img src="assets/images/ontime.png" alt="" style="width:70px;"></br>
              <h4 style="color:#fff;">ON-TIME DELIVERY:</h4> On the Dot Cargo Delivery Just for You!
              </div>
              
              <div class="partner-item">
              <img src="assets/images/insurance.png" alt="" style="width:68px;"></br>
              <h4 style="color:#fff;">INSURANCE:</h4> We Ensure the Safety of Your Parcel.
              </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="section-heading">
              <h2>Get the best <em>Price</em></h2>
              <span>Please fill up the form </span>
            </div>
          </div>
          <!-- Form Section -->
          <form action="qoutes_pages2.php" method="post">
          <div class="col-md-12">
            <div class="contact-form">
              <form id="contact" action="qoutes_pages2.php" method="post">
                <div class="row">
                  <div class="col-lg-6 col-md-12 col-sm-12">
                    <fieldset>
                      <input name="origin_city" type="text" class="form-control" id="origin_city" placeholder="Sender's Address" required="">
                    </fieldset>
                  </div>
                  <div class="col-lg-6 col-md-12 col-sm-12">
                    <fieldset>
                      <input name="destination" type="text" class="form-control" id="destination" placeholder="Recepient's Address" required="">
                    </fieldset>
                  </div>
                  <div class="col-lg-3 col-md-12 col-sm-12">
                    <fieldset>
                      <input name="weight" type="text" class="form-control" id="weight" placeholder="Weight (kg)" required="">
                    </fieldset>
                  </div>
                  <div class="col-lg-3 col-md-12 col-sm-12">
                    <fieldset>
                      <input name="length" type="text" class="form-control" id="length" placeholder="Length (cm)" required="">
                    </fieldset>
                  </div>
                  <div class="col-lg-3 col-md-12 col-sm-12">
                    <fieldset>
                      <input name="width" type="text" class="form-control" id="width" placeholder="Width (cm)" required="">
                    </fieldset>
                  </div>
                  <div class="col-lg-3 col-md-12 col-sm-12">
                    <fieldset>
                      <input name="height" type="text" class="form-control" id="height" placeholder="Height (cm)" required="">
                    </fieldset>
                  </div>
                  <!-- <div class="col-lg-12">
                    <fieldset>
                  ...
                  <div class="col-lg-12">
                    <fieldset>
                      <button type="submit" id="form-submit" class="filled-button">Get A Quote</button>
                    </fieldset>
                  </div>
                </div>
              </form>
