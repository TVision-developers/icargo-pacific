        ...
        <div class="row">
          <div class="col-md-4">
            <div class="contact-item">
              ...
              <h4>Phone</h4>
              <p> Relay service calls are always accepted at the following number.</p>
              <a href="#">0917-692-4203</a>
            </div>
          </div>
          <div class="col-md-4">
            <div class="contact-item">
              ...
              <h4>Email</h4>
              <p>Learn more about our teams and services.email us at; </p>
              <a href="#">info@icargo.ph</a>
            </div>
          </div>
          <div class="col-md-4">
            <div class="contact-item">
              ...
              <h4>Location</h4>
              <p>BGC Corporate Center, 30th Street,<br>Taguig, Manila</p>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="section-heading">
              ...
              <span>We are happy to assist you.</span>
            </div>
          </div>
          <div class="col-md-12">
